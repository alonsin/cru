...
class TournamentPlayersSubitaTres extends Component
{
	...
	#[On('refreshAllDataSubitaTres')]
	public function refreshAllDataSubitaTres()
	{
		$this->loadandupdateDataSubita();
	}
	...
	{
		return view('livewire.tournaments.tournamentregional.tournament-player-subita-tres');
	}
}
