...
class TournamentPlayersSubitaDos extends Component
{
	...
	#[On('refreshAllDataSubitaDos')]
	public function refreshAllDataSubitaDos()
	{
		$this->loadandupdateDataSubita();
	}
	...
	{
		return view('livewire.tournaments.tournamentregional.tournament-player-subita-dos');
	}
}
