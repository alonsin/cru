...
class TournamentPlayersTable3 extends DataTableComponent
{
    use CreateGames;
    protected $listeners = ['refreshTablePlayersTournament' => 'refreshtable', 'setSaveSorteo3'];
    protected $model = Player::class;
    public array $inputs = [];
    protected $index = 0;
    public $horario = "15:00";
    public $idtournament;
    ...
    public function mount()
    {
        $this->inputs = TournamentPlayer::where('horario', $this->horario)
            ->where('id_tournament', $this->idtournament)
            ->pluck('sorteo_principal', 'id')
            ->toArray();
    }

    public function setSaveSorteo3()
    {
        ...
        $this->dispatch('refreshAllDataSubitaTres');
