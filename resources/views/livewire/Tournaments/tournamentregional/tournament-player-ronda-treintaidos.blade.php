<div>
	...
	<div class="text-center mt-0 mb-3">
		...
		<button wire:click="guardarAjustes" class="btn btn-primary">
			<i class="bi bi-shuffle"></i> Actualizar Juegos
		</button>
	</div>
								...
								<tr class="{{ $rowClass }}">
									...
									<td>
										...
										<span class="badge bg-dark">
											<i class="bi bi-basket3-fill me-1"></i> {{ $mesaActual }}
										</span>
										@else
										<div class="d-flex justify-content-center">
											<select wire:model="mesaSeleccionada.{{ $juego['id'] }}"
												class="form-select form-select-sm mesa-select bg-mesa"
												style="padding: 0.1rem 0.25rem; font-size: 0.65rem; line-height: 1; border-radius: 0.3rem; width: 100%; max-width: 100%;">
